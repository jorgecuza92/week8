...
// use connection string to create thge pg-promise object
...
app.post('/add-book', (req,res) => {
  ...
  db.none('INSERT INTO books(name, isbn, author, is_published, rating) VALUES($1, $2, $3, $4, $5)',
  [name, isbn, author, isPublished, rating])
  .then(() => {
    res.redirect('/')
  })
...
// get all books where rating is 3
